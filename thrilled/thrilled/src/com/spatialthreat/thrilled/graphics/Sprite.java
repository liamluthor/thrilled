...
public class Sprite {
	...
	public static Sprite concrete 	  = new Sprite(16, 21, 0, SpriteSheet.tiles);
	...
	public static Sprite player2_down   = new Sprite(16, 4, 29, SpriteSheet.tiles);
	
	public static Sprite cyclops 		= new Sprite(16, 7, 29, SpriteSheet.tiles);
